    ...
    <div class="row d-flex justify-content-center py-4">
        <div class="col-sm-8 ">
            ...
            <article class="description">
                Questo è il progetto PHP & MySQL, un sito TodoList che permette all'utente di creare un account personale.
                Dopo di che sarà in grado di creare una lista di compiti da fare e definire il loro stato, cioè se è in corso,
                finito ecc...
                Ecco il link <a href="https://codeload.github.com/Amar1921/amar-syll-php/zip/master" target="_blank" class="text-success-50" style="color: blue ;font-size: larger">Github</a> del progetto.
            </article>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img alt="img1" class="d-block w-100 img-fluid" src="../assets/img/php_mysql/php--1.png">
                    </div>
                    <div class="carousel-item">
                        <img alt="img2" class="d-block w-100 img-fluid" src="../assets/img/php_mysql/php-11.png">
                    </div>
                    <div class="carousel-item">
                        <img alt="img3" class="d-block w-100 img-fluid" src="../assets/img/php_mysql/php--5.png">
                    </div>
                </div>
